        ...
        <div className="rounded-[2rem] border border-fuchsia-200/15 bg-black/55 p-5 shadow-[0_0_44px_rgba(217,70,239,0.12)]">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link className="rounded-full border border-emerald-200/20 bg-emerald-400/10 px-4 py-2 text-sm font-semibold text-emerald-100" href="/admin/app-licenses">
                Activation Codes
              </Link>
              <Link className="rounded-full border border-sky-200/20 bg-sky-400/10 px-4 py-2 text-sm font-semibold text-sky-100" href="/admin/wallpapers">
                Wallpapers
              </Link>
            </div>
          </div>
