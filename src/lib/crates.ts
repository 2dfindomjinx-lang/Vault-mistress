...
export const CRATE_TYPES: Record<string, Omit<CrateType, "crate_type"> & { drops: Array<{ item_id: string; weight: number; variant?: string }>; icon_url?: string }> = {
  principessa_case: {
    ...
    drops: [
      ...
      // Common %44
      { item_id: "boxer", weight: 400 },
      { item_id: "classic-collar", weight: 400 },
      { item_id: "classic-ears", weight: 400 },
      { item_id: "classic-tail", weight: 400 },
      { item_id: "white-pawmitts", weight: 400 },
	  { item_id: "ballgag", weight: 400 },
	  { item_id: "pet-tag", weight: 400 },
	  { item_id: "classic-bra", weight: 400 },
      { item_id: "classic", weight: 400 },
      { item_id: "classic-blindfold", weight: 400 },
      { item_id: "classic-pawmitts", weight: 400 },

      // Uncommon %22.5
	  { item_id: "owned-tag", weight: 230 },
	  { item_id: "pink-collar", weight: 230 },
      { item_id: "pink-ears", weight: 230 },
      { item_id: "cute-panties", weight: 230 },
      { item_id: "pink-bra", weight: 230 },
      { item_id: "pink-blindfold", weight: 220 },
	  { item_id: "classic-buttplug", weight: 220 },
      { item_id: "classic-highheels", weight: 220 },
      { item_id: "classic-skirt", weight: 220 },
      { item_id: "classic-thighhighs", weight: 220 },
      ...
      // Epic %12.5
	  { item_id: "gorgeous-panties", weight: 210 },
      { item_id: "gorgeous-bra", weight: 210 },
      { item_id: "gorgeous-buttplug", weight: 210 },
      { item_id: "gorgeous-highheels", weight: 210 },
      { item_id: "gorgeous-pawmitts", weight: 210 },
      { item_id: "gorgeous-thighhighs", weight: 200 },
