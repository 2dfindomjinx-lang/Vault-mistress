...
const FeedPostCard = memo(function FeedPostCard({
  ...
  return (
    <article className={`${styles.feedPost} [contain-intrinsic-size:auto_520px] [content-visibility:auto] border-b transition ${post.highlightedUntil ? "border-amber-300/30 bg-[linear-gradient(135deg,rgba(251,191,36,.11),rgba(236,72,153,.06))] shadow-[inset_3px_0_0_#f4c06a]" : "border-white/10 hover:bg-white/[0.015]"}`}>
