...
export function AppShell({ activePage, children, coins, items, onAddCoins, onCoinsChange, onNavigate }: AppShellProps) {
  return (
    <div className="principessa-court-ui relative min-h-screen w-full overflow-x-hidden bg-[#060305]">
      ...
      <SidebarNav activePage={activePage} coins={coins} items={items} onAddCoins={onAddCoins} onSelect={onNavigate} />
