...
export function TopLevelNav({ active }: { active: "feed" | "main" }) {
  return (
    <nav className="relative isolate w-full overflow-hidden border-b border-[#f4c06a]/20 bg-[#090309] px-3 text-white shadow-[0_14px_40px_rgba(0,0,0,.45)]">
        <div className="absolute inset-0 -z-20 bg-[url('/principessa-feed/branding/principessa-feed-hero.webp')] bg-cover bg-[center_24%] opacity-20" />
      ...
      <div className="mx-auto flex min-h-[76px] w-full max-w-7xl items-center justify-between gap-4">
        <div className="hidden items-center gap-3 sm:flex">
          <div className="h-11 w-11 rounded-full border border-[#f4c06a]/50 bg-[url('/principessa-feed/branding/principessa-feed-mark-v2.webp')] bg-cover bg-center shadow-[0_0_24px_rgba(236,72,153,.3)]" />
          <div>
