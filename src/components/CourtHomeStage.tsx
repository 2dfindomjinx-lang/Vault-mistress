...
export function CourtHomeStage({ affection, coins, dailyMessage, displayName, money = 0, onNavigate }: CourtHomeStageProps) {
  return (
    <section className="relative isolate min-h-[24rem] overflow-hidden border border-[#c89a55]/20 bg-[#090507] sm:min-h-[26rem] lg:min-h-[28rem]">
      ...
      <div className="court-home-portrait pointer-events-none absolute z-10">
        <div className="absolute bottom-[8%] left-[12%] right-[6%] hidden h-28 rounded-[50%] bg-black/80 blur-2xl sm:block" />
        <Image alt="Principessa standing with her arms crossed over the command console" className="object-contain object-top sm:object-bottom" fill preload quality={82} sizes="(min-width: 1024px) 42vw, (min-width: 640px) 58vw, 50vw" src="/principessa-ui/generated/principessa-home-command.webp" />
      </div>
