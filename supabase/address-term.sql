-- Free, user-changeable preference: sub / femsub.
-- Used for short UI copy ("Good boy" / "Good girl"), speech-bubble
...
set address_term = 'sub'
where address_term is null or address_term = '' or address_term = 'neutral';
...
BEGIN
  ...
  ALTER TABLE public.profiles
    ...
    CHECK (address_term IN ('sub', 'femsub'));
END $$;
